 ...
 *
 * @param {String} url Base keystone server url.
 * @param {String} version Keystone API version, defaults to 2.0.
 * @param {Object} options Authentication options (username, apiKey, password,
 * cacheTokenFor).
 * @constructor
 */
function KeystoneClient(url, version, options) {
  options = options || {};
  ...
  this._url = sprintf('%s/v%s', url, version);
 ...
 * @param {Function} callback Completion callback.
 */
KeystoneClient.prototype.getTenantInfo = function(tenantId, callback) {
 ...
 * @param {Function} callback Completion callback.
 */
KeystoneClient.prototype.getServiceCatalog = function(callback) {
  var self = this;
 ...
 * @param {Function} callback Completion callback.
 */
KeystoneClient.prototype.getTenantIdAndToken = function(callback) {
